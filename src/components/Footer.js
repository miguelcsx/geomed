        ...
        <footer className="bg-gray-600 text-white py-4 text-center">
            <div className="container mx-auto">
                <p className="text-center md:flex md:justify-between">
                    ...
                    <span className="block mt-4 md:mt-0 md:inline-block md:ml-4">Find us on <a href={githubRepoUrl} className="text-blue-400 hover:text-blue-200" target="_blank" rel="noopener noreferrer">GitHub</a></span>
                </p>
            </div>
        </footer>
    );
